      ...
      <div class="flex flex-grow items-center justify-center bg-gray-900 h-full">
            ...
            <div class="max-w-full p-8 bg-gray-800 rounded-lg shadow-lg w-96 text-gray-200">
                ...
                <div>
                    ...
                    <input class="flex-grow h-8 ml-4 bg-transparent focus:outline-none font-medium" v-model="newTask" @keyup.enter="addTask" type="text" :placeholder="editingTask ? 'Modifier la tâche' : 'Ajouter une tâche'">
                    </button>
...
<script>
    ...
    methods: {
        ...
        if (this.newTask.trim() !== '') {
            ...
            this.editingTask.text = this.newTask;
